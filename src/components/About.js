...
const aboutText = {
    intro: "I am Kevin J.K from Indonesia, an Information Engineering & Media Student from Nanyang Technological University. I've been programming for 5 years, which range from Competitive Programming, Front End Development, and currently Data Sceince and Machine Learning.",
    contact: "Contact",
    contactList: [
        {
            name: "instagram",
            ...
            img: <svg width="50px" height="50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        },
        {
            ...
            link: "",
            img: <svg width="50px" height="50px" viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="none"><path stroke="#000000" stroke-linejoin="round" stroke-width="12" d="M22 57.265V142c0 5.523 4.477 10 10 10h24V95.056l40 30.278 40-30.278V152h24c5.523 0 10-4.477 10-10V57.265c0-13.233-15.15-20.746-25.684-12.736L96 81.265 47.684 44.53C37.15 36.519 22 44.032 22 57.265Z"/></svg>,
        }
    ],
}
    ...
    return(
        <div id="about" style={{
            ...
            <div style={{
                ...
                <div id="about-intro" style={{textAlign:"justify"}}>{aboutText.intro}</div>
                
                <h2 className="about-heading">{aboutText.contact}</h2>
                <div className="contact-container">
                    {
                        aboutText.contactList.map((contact, index) => {
                            return(
                                <span className="contact-item">
                                    <a href={contact.link}>{contact.img}</a>
                                </span>
