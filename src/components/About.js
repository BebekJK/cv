...
const aboutText = {
    intro: "I am Kevin J.K from Indonesia, an Information Engineering & Media Student from Nanyang Technological University. Being passionate in the field of technology, I've been doing programming for 5 years, which range from Competitive Programming, Front End Development, and currently Data Sceince and Machine Learning.",
    contact: "Contact",
    contactList: [
        {
            name: "instagram",
...
const About = () => {
    ...
    return(
        <div name="about" id="about" className="bg-transparent h-full w-full px-8 py-8 font-light">
                <h2 className="text-[#B000B0] font-bold drop-shadow-lg">ABOUT ME</h2>
